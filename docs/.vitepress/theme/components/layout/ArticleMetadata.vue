  ...
  <div class="meta-wrapper">
    <div class="meta-item">
      ...
      <span class="meta-content">
        <a v-if="isOriginal" :href="authorLink" title="About Author">{{ author }}</a>
    ...
    <div class="meta-item">
      <span class="meta-icon date">
        <svg role="img" viewBox="0 0 1024 1024" xmlns="http://www.w3.org/2000/svg">
          <title v-if="isOriginal">Published On</title>
          <title v-else>Republished On</title>
      ...
      <time v-if="props?.article?.date" class="meta-content" :datetime="date.toISOString()" :title="publishedOn">{{ publishedOn }}</time>
      <span v-else>--</span>
    </div>
    <div class="meta-item" v-if="showViewCount">
      <span class="meta-icon pv">
        <svg role="img" viewBox="0 0 1024 1024" xmlns="http://www.w3.org/2000/svg"><title>Views</title><path d="M942.2 486.2C847.4 286.5 704.1 186 512 186c-192.2 0-335.4 100.5-430.2 300.3-7.7 16.2-7.7 35.2 0 51.5C176.6 737.5 319.9 838 512 838c192.2 0 335.4-100.5 430.2-300.3 7.7-16.2 7.7-35 0-51.5zM512 766c-161.3 0-279.4-81.8-362.7-254C232.6 339.8 350.7 258 512 258c161.3 0 279.4 81.8 362.7 254C791.5 684.2 673.4 766 512 766z"></path><path d="M508 336c-97.2 0-176 78.8-176 176s78.8 176 176 176 176-78.8 176-176-78.8-176-176-176z m0 288c-61.9 0-112-50.1-112-112s50.1-112 112-112 112 50.1 112 112-50.1 112-112 112z"></path></svg>
      </span>
...
<script lang="ts" setup>
  ...
  const publishedOn = computed(() => {
    return data.date.toLocaleString('en', { year: 'numeric', month: 'numeric', day: 'numeric', hour: 'numeric', minute: 'numeric' })
  })
